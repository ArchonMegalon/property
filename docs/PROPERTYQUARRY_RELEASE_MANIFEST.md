...
| Branch | `main` |
| Runtime commit SHA | `767e9856f5d33a6c9dcd9110291708ae0ba095df` |
...
The candidate at `767e985` passed:
...
| `/app/research/<listing>` | authenticated origin smoke observed 1.70s, 1.34s, and 1.36s after removing repeated write contention for the user-referenced route |
