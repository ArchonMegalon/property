                ...
                runtime_policy_json={
                    ...
                    "skill_catalog_json": {
                        ...
                        "input_schema_json": {
                            "type": "object",
                            "properties": {
                                "provider_key": {"type": "string", "enum": ["mootion", "magicfit", "omagic", "magic"]},
                        ...
                        "provider_hints_json": {
                            "primary": ["BrowserAct", "1min.AI", "MagicFit"],
                            "notes": [
                                "magic is accepted as an alias for OMagic/1min i2v.",
                                "MagicFit and OMagic scene briefings auto-seed a first frame when the caller does not provide one.",
                            ],
                        },
                        "tool_policy_json": {
