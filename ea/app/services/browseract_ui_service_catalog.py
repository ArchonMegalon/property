...
_SERVICE_DEFINITIONS: tuple[BrowserActUiServiceDefinition, ...] = (
    ...
    _template_reader_service(
        service_key="poppy_workspace_reader",
        capability_key="poppy_workspace_reader",
        tool_name="browseract.poppy_workspace_reader",
        skill_key="inspect_poppy_workspace",
        task_key="inspect_poppy_workspace",
        name="Inspect Poppy AI Workspace",
        description="Template-backed BrowserAct Poppy AI workspace reader for board capture, source-cluster inspection, and synthesis-surface discovery.",
        deliverable_type="poppy_workspace_packet",
        browseract_names=("BrowserAct", "Poppy AI"),
        aliases=("poppy", "poppy_ai", "poppy_workspace", "inspect_poppy_workspace"),
