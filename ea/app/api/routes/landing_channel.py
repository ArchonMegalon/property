...
def app_channel_action(
    ...
    return _render_secure_link_page(
        ...
        link_summary="Open the related page to confirm the result or continue through sign in if you need a fresh session.",
        ...
        link_rows=[
            {
                ...
                "detail": "This secure link already saved the requested decision.",
            },
            {
                "label": "Next page",
                "value": return_to,
                "detail": "Open the related page to review the updated state.",
            },
        ],
        primary_action_href=return_to,
        primary_action_label="Open related page",
        secondary_action_href="/sign-in",
        secondary_action_label="Request sign-in link",
    )
...
def channel_digest_delivery_open(
    ...
    if delivery is None:
        return _render_secure_link_page(
            ...
            link_summary="Request a fresh sign-in link or wait for the next update if you still need this view.",
            link_detail_title="Details",
            ...
            link_rows=[
                ...
                {"label": "Recovery", "value": "Request another secure link", "detail": "Use sign in if you already have workspace access or wait for the next update."},
            ],
            primary_action_href="/sign-in",
            primary_action_label="Request new sign-in link",
            secondary_action_href="/register",
