        ...
        "settings": {
            ...
            "cards": [
                ...
                },
                {
                    ...
                    "title": "How daily work is moving",
                    "body": "Shows whether summaries are opened, approvals move, and open work closes at a believable rate.",
                    "items": [
                        _row("Current state", str(office_loop_proof.get("state") or "watch").replace("_", " ").title(), "Status", href="/app/settings/outcomes"),
                        _row(
                            "Healthy signals",
                ...
                },
                {
                    ...
                    "body": "Shows the current product pulse without turning the workspace into a roadmap console.",
                    "items": [
