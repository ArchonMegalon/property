...
- The exact four-command startup block was completed before any added orientation step.
- The required direct-read context files were read as follow-on context only.
