...
Frontier: `4287684466`
Retry label: implementation-only successor-wave retry
Milestone: `103`
Owned surfaces: `parity_lab:capture`, `veteran_compare_packs`

Implementation-only retry proof:

- The exact four-command startup block was run before any extra orientation or repo-local inspection.
- The broader direct-read file list was read after the startup block and treated as context only.
