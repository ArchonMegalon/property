...
15. `RELEASE_PIPELINE.md`
16. `PUBLIC_DOWNLOADS_POLICY.md`
17. `DESKTOP_CLIENT_PRODUCT_CUT.md`
18. `DESKTOP_PLATFORM_ACCEPTANCE_MATRIX.yaml`
19. `DESKTOP_AUTO_UPDATE_SYSTEM.md`
20. `PUBLIC_AUTO_UPDATE_POLICY.md`
21. `LOCALIZATION_AND_LANGUAGE_SYSTEM.md`
22. `LOCALIZATION_PARITY_MATRIX.yaml`
23. `ACCOUNT_AWARE_INSTALL_AND_SUPPORT_LINKING.md`
24. `FEEDBACK_AND_CRASH_REPORTING_SYSTEM.md`
25. `FEEDBACK_AND_SIGNAL_OODA_LOOP.md`
26. `FEEDBACK_AND_CRASH_AUTOMATION.md`
27. `FEEDBACK_AND_CRASH_STATUS_MODEL.md`
28. `PUBLIC_LANDING_POLICY.md`
29. `PUBLIC_LANDING_MANIFEST.yaml`
30. `PUBLIC_FEATURE_REGISTRY.yaml`
31. `PUBLIC_LANDING_ASSET_REGISTRY.yaml`
32. `PUBLIC_USER_MODEL.md`
33. `PUBLIC_AUTH_FLOW.md`
34. `IDENTITY_AND_CHANNEL_LINKING_MODEL.md`
35. `PUBLIC_MEDIA_BRIEFS.yaml`
36. `PARTICIPATION_AND_BOOSTER_WORKFLOW.md`
37. `COMMUNITY_SPONSORSHIP_BACKLOG.md`
38. `EXTERNAL_TOOLS_PLANE.md`
39. `LTD_CAPABILITY_MAP.md`
40. `PUBLIC_GUIDE_POLICY.md`
41. `PUBLIC_GUIDE_PAGE_REGISTRY.yaml`
42. `PUBLIC_PART_REGISTRY.yaml`
43. `PUBLIC_FAQ_REGISTRY.yaml`
44. `PUBLIC_HELP_COPY.md`
45. `PUBLIC_GUIDE_EXPORT_MANIFEST.yaml`
46. `HORIZON_SIGNAL_POLICY.md`
47. `PUBLIC_MEDIA_AND_GUIDE_ASSET_POLICY.md`
48. `METRICS_AND_SLOS.yaml`
49. `PUBLIC_TRUST_CONTENT.yaml`
50. `journeys/README.md`
51. `OWNERSHIP_MATRIX.md`
52. `PROGRAM_MILESTONES.yaml`
53. `CONTRACT_SETS.yaml`
54. `GROUP_BLOCKERS.md`
55. `projects/*.md` for repo-specific scope
56. `CAMPAIGN_SPINE_AND_CREW_MODEL.md`
57. `CHARACTER_LIFECYCLE_AND_LIVING_DOSSIER.md`
58. `ROAMING_WORKSPACE_AND_ENTITLEMENT_SYNC.md`
59. `CAMPAIGN_WORKSPACE_AND_DEVICE_ROLES.md`
60. `PRODUCT_CONTROL_AND_GOVERNOR_LOOP.md`
61. `SUPPORT_AND_SIGNAL_OODA_LOOP.md`
62. `USER_JOURNEYS.md`
63. `EXPERIENCE_SUCCESS_METRICS.md`
64. `PUBLIC_NAVIGATION.yaml`
65. `PUBLIC_PROGRESS_PARTS.yaml`
66. `PUBLIC_CAMPAIGN_IMAGE_MANIFEST.yaml`
67. `PUBLIC_RELEASE_EXPERIENCE.yaml`
68. `BUILD_LAB_PRODUCT_MODEL.md`
69. `ACCOUNT_AWARE_FRONT_DOOR_CLOSEOUT.md`
70. `NEXT_WAVE_ACCOUNT_AWARE_FRONT_DOOR.md`
71. `NEXT_15_BIG_WINS_EXECUTION_PLAN.md`
72. `NEXT_20_BIG_WINS_EXECUTION_PLAN.md`
73. `NEXT_20_BIG_WINS_REGISTRY.yaml`
74. `POST_AUDIT_NEXT_20_BIG_WINS_GUIDE.md`
75. `POST_AUDIT_NEXT_20_BIG_WINS_REGISTRY.yaml`
76. `POST_AUDIT_NEXT_20_BIG_WINS_CLOSEOUT.md`
77. `NEXT_20_BIG_WINS_AFTER_POST_AUDIT_CLOSEOUT_GUIDE.md`
78. `NEXT_20_BIG_WINS_AFTER_POST_AUDIT_CLOSEOUT_REGISTRY.yaml`
79. `INTEROP_AND_PORTABILITY_MODEL.md`
80. `RULE_ENVIRONMENT_AND_AMEND_SYSTEM.md`
81. `PROVIDER_AND_ROUTE_STEWARDSHIP.md`
82. `CAMPAIGN_OS_GAP_AND_CHANGE_GUIDE.md`
83. `GOLDEN_JOURNEY_RELEASE_GATES.yaml`
84. `JOURNEY_GATES.generated.json`
85. `PRIVACY_AND_RETENTION_BOUNDARIES.md`
86. `FLAGSHIP_PRODUCT_BAR.md`
87. `SURFACE_DESIGN_SYSTEM_AND_AI_REVIEW_LOOP.md`
88. `CHUMMER5A_FAMILIARITY_BRIDGE.md`
89. `DENSE_WORKBENCH_BUDGET.yaml`
90. `VETERAN_FIRST_MINUTE_GATE.yaml`
91. `PRIMARY_ROUTE_REGISTRY.yaml`
92. `DESKTOP_EXECUTABLE_EXIT_GATES.md`
93. `FLAGSHIP_RELEASE_ACCEPTANCE.yaml`
94. `LEGACY_CLIENT_AND_ADJACENT_PARITY.md`
95. `LEGACY_CLIENT_AND_ADJACENT_PARITY_REGISTRY.yaml`
96. `FLAGSHIP_PARITY_REGISTRY.yaml`
97. `NEXT_12_BIGGEST_WINS_GUIDE.md`
98. `NEXT_12_BIGGEST_WINS_REGISTRY.yaml`
99. `PRODUCT_USAGE_TELEMETRY_MODEL.md`
100. `PRODUCT_USAGE_TELEMETRY_EVENT_SCHEMA.md`
101. `PUBLIC_VIDEO_BRIEFS.yaml`
102. `MEDIA_ARTIFACT_RECIPE_REGISTRY.yaml`
103. `STRUCTURED_VIDEO_AND_NARRATED_MEDIA_MODEL.md`
104. `VIDBOARD_AND_LTD_WOW_FACTOR_WORKFLOWS.md`
105. `adrs/ADR-0016-structured-presenter-video-lane.md`
106. `COMPANION_PERSONA_AND_INTERACTION_MODEL.md`
107. `COMPANION_PACKET.md`
108. `COMPANION_TRIGGER_REGISTRY.yaml`
109. `COMPANION_EVENT_SCHEMA.yaml`
110. `adrs/ADR-0017-first-party-companion-runtime-and-bounded-voice-mode.md`
111. `LTD_DISCOVERY_OUTREACH_AND_VALIDATION_INTEGRATION_GUIDE.md`
112. `ICANPRENEUR_DISCOVERY_AND_VALIDATION_LANE.md`
113. `KARMA_FORGE_DISCOVERY_AND_HOUSE_RULE_INTAKE.md`
114. `HOUSE_RULE_DISCOVERY_REGISTRY.yaml`
115. `PRODUCTLIFT_FEEDBACK_ROADMAP_BRIDGE.md`
116. `KATTEB_PUBLIC_GUIDE_OPTIMIZATION_LANE.md`
117. `PUBLIC_SIGNAL_TO_CANON_PIPELINE.md`
118. `PUBLIC_FEEDBACK_AND_CONTENT_REGISTRY.yaml`
119. `PUBLIC_FEEDBACK_TAXONOMY.yaml`
120. `PUBLIC_SITE_VISIBILITY_AND_SEARCH_OPTIMIZATION.md`
121. `SIGNITIC_FACTION_WAR_AND_WORLD_TICK_CAMPAIGNS.md`
122. `LTD_RUNTIME_AND_PROJECTION_REGISTRY.yaml`
123. `TEABLE_ADMIN_PROJECTION_AND_INTENT_LAYER.md`
124. `ADMIN_INTENT_AND_PROJECTION_RECEIPTS.yaml`
125. `EMAILIT_OUTBOUND_DELIVERY_PROVIDER.md`
126. `OUTBOUND_NOTIFICATION_TEMPLATE_REGISTRY.yaml`
127. `EMAIL_DELIVERY_RECEIPT_MODEL.md`
128. `PRODUCT_ANALYTICS_AND_JOURNEY_PROOF_MODEL.md`
129. `JOURNEY_PROOF_EVENTS.yaml`
130. `ARTIFACT_FACTORY_PIPELINE_MODEL.md`
131. `MEDIA_RECIPE_EXECUTION_AND_CLOSEOUT.yaml`
132. `BLACK_LEDGER_ADMIN_WORKBENCH_MODEL.md`
133. `BLACK_LEDGER_SEASON_OPERATOR_PLAYBOOK.md`
134. `WORLD_TICK_AND_OPEN_RUN_CLOSEOUT_SOPS.yaml`
135. `COMMUNITY_HUB_OPERATIONS_MODEL.md`
136. `KARMA_FORGE_DISCOVERY_LAB_WORKFLOWS.yaml`
137. `TABLE_PULSE_DEBRIEF_STUDIO_WORKFLOWS.yaml`
138. `PUBLIC_GROWTH_AND_VISIBILITY_STACK.md`
139. `USER_CONTRIBUTION_PRIVACY_AND_IP_POLICY.md`
140. `USER_CONTRIBUTION_VISIBILITY_REGISTRY.yaml`
141. `COMPANION_LINE_PACK_AND_TRIGGER_OPERATIONS.md`
142. `COMPANION_LINE_PACK_REGISTRY.yaml`
143. `PREMIUM_AND_COMMUNITY_PACKAGING_MODEL.md`
144. `PREMIUM_CAPABILITY_REGISTRY.yaml`
145. `FLAGSHIP_READINESS_PLANES.yaml`
146. `CHUMMER5A_HUMAN_PARITY_ACCEPTANCE_SPEC.md`
147. `CHUMMER5A_HUMAN_PARITY_ACCEPTANCE_MATRIX.yaml`
148. `READY_FOR_TONIGHT_MODE.md`
149. `READY_FOR_TONIGHT_GATES.yaml`
150. `PUBLIC_ONBOARDING_PATHS_FOR_NO_DESKTOP_USERS.md`
151. `ROLE_KITS_AND_STARTER_LOADOUTS.md`
152. `ROLE_KIT_REGISTRY.yaml`
153. `SOURCE_AWARE_EXPLAIN_PUBLIC_TRUST_HOOK.md`
154. `CAMPAIGN_ADOPTION_START_FROM_TODAY_FLOW.md`
155. `FOUNDRY_FIRST_VTT_HANDOFF_PROOF.md`
156. `VTT_EXPORT_TARGET_ACCEPTANCE.yaml`
157. `COMMUNITY_SAFETY_MODERATION_AND_APPEALS.md`
158. `COMMUNITY_SAFETY_EVENT_AND_APPEAL_STATES.yaml`
159. `WORLD_BROADCAST_AND_FACTION_PROPAGANDA_CADENCE.md`
160. `WORLD_BROADCAST_RECIPE_REGISTRY.yaml`
161. `CREATOR_DASHBOARD_AND_ADOPTION_ANALYTICS.md`
162. `CREATOR_PUBLICATION_ANALYTICS_SCHEMA.yaml`
163. `ACCESSIBILITY_AND_COGNITIVE_LOAD_RELEASE_BAR.md`
164. `ACCESSIBILITY_COGNITIVE_LOAD_GATES.yaml`
165. `RUNNER_PASSPORT_AND_CROSS_COMMUNITY_TRUST.md`
166. `RUNNER_PASSPORT_ACCEPTANCE.yaml`
167. `WORLD_DISPATCH_AND_REACTIVATION_LOOP.md`
168. `WORLD_DISPATCH_REACTIVATION_GATES.yaml`
169. `CREATOR_OPERATING_SYSTEM.md`
170. `LTD_CADENCE_AND_FOLLOWTHROUGH_SYSTEM.md`
171. `LTD_CADENCE_AND_FOLLOWTHROUGH_REGISTRY.yaml`
172. `EXPLAIN_EVERY_VALUE_AND_GROUNDED_FOLLOW_UP.md`
