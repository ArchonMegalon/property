...
PROVIDER_SPECS = [
    ...
    {"provider": "Unmixr AI", "service_key": "Unmixr AI", "role": "voice_cleanup", "status": "pilot", "commercial_use_allowed": False, "watermark_free": True, "max_duration": "n/a", "max_resolution": "audio_only", "api_available": False, "manual_workflow_allowed": True, "privacy_terms_reviewed": False, "source_data_allowed": False},
